...
export default story({
  ...
  matrix: false,
  // It takes whatever width it is given - under a poster tile that is 170pt,
  // under the player it is the screen - so the story is given a range rather
  // than the one width that would hide a bug at any other.
