...
// motion; this keeps the navigator library's virtualised grid, whose behaviour
// down a column is what a grid wants and whose virtual nodes are what keep the
// D-pad reaching the bottom of the library.
//
