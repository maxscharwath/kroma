...
// Locale-aware copy. The French stays verbatim (accuracy-corrected, em-dash-free);
// the English is native prose that carries the exact same honest posture, never
// overstating, never omitting. Both languages keep the page short and plain on
// purpose: KROMA holds almost no personal data because there is almost nothing to
// hold (no accounts on the site, no cloud behind the app). The one component that
// touches a service we operate, the Cloudflare push relay, is named openly rather
// than buried, because pretending it does not exist would be the dishonest choice.
const copy = {
  fr: {
    ...
    <Container size="prose">
      <article className="py-16 sm:py-20">
        <header>
          ...
          <p className="mt-5 text-sm text-dim">{t.updated}</p>
