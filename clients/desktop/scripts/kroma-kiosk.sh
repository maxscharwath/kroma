#!/usr/bin/env bash
# KROMA Steam Deck kiosk launcher.
#
...
#
# Usage:
#   ./kroma-kiosk.sh                                   # serve ../dist locally, open it
#   KROMA_DIR=/home/deck/kroma-deck ./kroma-kiosk.sh     # serve a dist elsewhere
#   KROMA_URL=http://192.168.1.50:8080/ ./kroma-kiosk.sh  # already hosted; just open it
#
...
"${CHROME[@]}" \
  --user-data-dir="$HOME/.kroma-deck-chrome" \
  --kiosk \
  --app="$URL" \
  --start-fullscreen \
