...
// schema it pinned, not whatever the contract became. Adding v4 is a new file
// beside this one, a line in `MANIFEST_SCHEMAS`, and a bump below.

import type { z } from 'zod';
import { Manifest as V2 } from './v2.ts';
import { Manifest as V3 } from './v3.ts';
...
export const MANIFEST_SCHEMAS: Record<number, z.ZodType> = { 2: V2, 3: V3 };

// The shapes v3 did not touch keep their one definition in v2.
export { ArtifactRef, ConfigField, REVERSE_DNS_ID } from './v2.ts';
export {
  CoreScope,
  DescribedModule,
  dependenciesOf,
