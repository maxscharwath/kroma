...
export function Button({ variant = 'primary', size = 'md', icon = null, children, style = {}, ...rest }) {
  const sizes = {
  ...
  const variants = {
    ...
    glass: { background: 'rgba(255,255,255,.1)', color: 'var(--luma-text)', border: '1px solid var(--luma-border-strong)' },
  ...
  return React.createElement('button', {
    style: {
      ...
      fontFamily: 'var(--font-ui)', fontSize: s.fontSize, fontWeight: s.fontWeight, padding: s.padding,
