...
import { Focusable } from '../primitives/focusable';
import { Img } from '../primitives/img';
import { Progress } from '../primitives/progress';
import { Txt } from '../primitives/text';
import { WatchedBadge } from '../primitives/watched-badge';
import { tintGradient } from './media-card';

/** Steeper than the rail tile's scrim: a poster is taller, so the fade has
 * further to travel before it reaches the title. */
const POSTER_SCRIM = 'linear-gradient(170deg, rgba(0, 0, 0, 0.05) 35%, rgba(0, 0, 0, 0.72) 100%)';
