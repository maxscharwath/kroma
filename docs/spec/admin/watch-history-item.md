# One title's watch history

Status: **AGREED**

Every count on the dashboard is an aggregate, and every aggregate eventually raises the
same question: who, exactly. This is the answer for one title, reached from anywhere that
names it.
...
table with headers. The reader arrived expecting rows and is owed the reason there are none.
...
each row names the episode it was. Asking about a show and being shown one episode's
history would answer a question nobody asked.
