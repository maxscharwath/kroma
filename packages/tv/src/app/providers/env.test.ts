...
//
// These cases describe BROWSER shells; computeEnv separates native targets
// from them by asking whether a DOM window exists, so a document is required
// here or every case would look native.
