...
// clock, and the two remote-driven on-screen inputs (a full keyboard for server
// URLs / search, a numeric keypad for PINs). Everything generic has moved to
// @kroma/ui/kit; what stays here is what depends on the TV app's own state (the
// device's keyboard-layout preference, the router).
//
