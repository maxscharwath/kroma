...
export default story({
  name: 'Grid',
  group: 'Media',
  docs: "The poster grid. The cell width is computed from the row's measured width, where the web would settle for a calc(): that is what keeps it identical across all four targets.",
  matrix: false,
