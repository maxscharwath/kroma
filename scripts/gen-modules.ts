...
// with zero manual wiring: crate `kroma-modules-generated` (register_all) and
// package `@kroma/modules-generated` (generatedModules).
//
// The `id` MUST be reverse-DNS (e.g. "tv.kroma.notes"); it is the runtime join
...
// ---- FE aggregator: @kroma/modules-generated --------------------------------
write(
