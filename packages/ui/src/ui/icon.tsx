...
import { type IconProps, resolveIcon } from '../lib/glyph';
import { Circle, Ellipse, Line, Path, Polygon, Polyline, Rect, Svg } from '../lib/svg';

export type { IconName, IconProps } from '../lib/glyph';
