...
| `KROMA_INSTALL`    | `unknown`   | How this server was installed: `docker`, `synology` or `binary`. Set by the packaging, and reported only with the opt-in anonymous statistics. See [`docs/anonymous-stats.md`](../docs/anonymous-stats.md). |
