// LUMA Android TV shell: a transparent WebView (the shared @luma/tv UI, bundled
...
//
//  - The web app detects the injected `__LUMA_ANDROID__` bridge (ExoBridge) and
...
//    @luma/core's remote mapping already understands.
package app.luma.tv
...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val playerView = PlayerView(this).apply {
            useController = false // LUMA draws its own chrome in the WebView
        ...
        webView.addJavascriptInterface(bridge, "__LUMA_ANDROID__")
    ...
    // @luma/core's KEY_NAMES map resolves (Escape -> Back, Media* -> transport).
