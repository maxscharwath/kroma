...
import { TINT, TITLES } from './virtual-rail.fixtures';
...
<Dont>
- Use it for a row of eight. Plain `Rail` mounts those in chunks and costs nothing.
- Put variable-width tiles in it: the windowing assumes one pitch.
</Dont>
