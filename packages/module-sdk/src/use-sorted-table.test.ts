...
const COLUMNS: SortedColumn<Grab, Key>[] = [
  { id: 'release', label: 'col.release', sortBy: 'title', ascendingFirst: true },
  { id: 'progress', label: 'col.progress', sortBy: 'progress', wide: true },
  { id: 'speed', label: 'col.speed', wide: true },
  { id: 'added', label: 'col.added', sortBy: 'grabbedAt' },
  { id: 'actions' },
];
...
function queue(query: GrabQuery = {}) {
