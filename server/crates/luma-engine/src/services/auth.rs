...
// Randomness primitives now live in luma-primitives (below the persistence layer, so
...
pub(crate) use luma_primitives::random_bytes;
pub use luma_primitives::{random_token, random_u32};
