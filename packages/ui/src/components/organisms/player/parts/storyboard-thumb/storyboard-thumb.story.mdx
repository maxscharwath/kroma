...
import { fakeTileAt } from '#ui/components/organisms/player/player.fixture';
import { stillArt } from '#ui/lib/sample-art';
import { StoryboardThumb } from './storyboard-thumb';
import { tileAt } from './storyboard-thumb.fixtures';
...
<Dont>
- Scale the image by asking for more pixels; scale the layer, or the GPU drops it.
</Dont>
