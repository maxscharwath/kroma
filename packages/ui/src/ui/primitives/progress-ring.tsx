...
import { RING_ROTATION, type RingProps, ringGeometry } from '../../lib/ring';
import { Circle, Svg } from '../../lib/svg';

export type { RingProps as ProgressRingProps } from '../../lib/ring';

function ProgressRing(props: Readonly<RingProps>) {
