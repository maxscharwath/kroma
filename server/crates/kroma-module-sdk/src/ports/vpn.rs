//! The VPN contracts: `VpnProxyPort` (the vpn module's local SOCKS5 bridge)
//! and `DownloadVpnPort` (the download engine's kill-switch surface).
...
use kroma_module_host::{call_raw, HostCtx, Resolver};
use serde_json::json;

use kroma_module_host::async_trait;
